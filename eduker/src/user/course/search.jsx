...
import { fetchCourseRequest,  searchCourseRequest } from "../../actions/course"
...
class Search extends React.Component {
    ...
    componentDidMount(){
        this.props.searchCourseRequest(this.state.title);
                        ...
                        <form action="/classNamees" method="get" id="filtersForm">
                            ...
                            <div className="row mt-20">
                                <div className="col-12 col-lg-12">
                                    ...
                                    <h2 class="mt-25 font-36">No result found for <b> "{this.props.params.name}"</b> you can try again.</h2> </div>}  
                                    </div>
                                </div>
...
const mapStateToProps = state => {
    return {        
        ...
        pageSearch: state.course.page,
        totalPagesSearch: state.course.totalPages,
...
export default withRouterParams(connect(mapStateToProps,mapDispatchToProps)(Search));
