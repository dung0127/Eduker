                    ...
                    <div className="row h-100 align-items-center justify-content-center text-center">
                        <div className="col-12 col-md-9 col-lg-7">
                            <div className="top-search-categories-form">
                                <h1 className="text-white font-30 mb-15">{subCatalog.name}</h1>
                                {subCatalog.description?
                                <span className="course-count-badge py-5 px-10 text-white rounded">{subCatalog.description}</span>
                                :''}
{/* 
                        ...
                        <div className="row mt-20">
                            <div className="col-12 col-lg-12">
                                ...
                                {subCatalog.courses&&subCatalog.courses.length>0?'':
                                    ...
                                    <h2 class="mt-25 font-36">No data found </h2>
                                    </div>               
                                }       
