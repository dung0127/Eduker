                                                ...
                                                this.props.coursesByActivate&&this.props.coursesByActivate.map((activate,m) => {
                                                    return (
                                                        <tr>
                                                            ...
                                                            <td className="align-middle">
                                                                <Link to={`/course-status/${activate.id}`} params={activate.id} ><span className="text-dark-blue"><img style={{height:"20px", width:"20px", cursor:"pointer"}} src="data:image/png;base64,"/></span></Link>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                <Link to={`/course-edit/${activate.id}`} params={activate.id} ><span><img style={{width:"21px", height:"21px", cursor:"pointer"}} src="assets/default/img/icons/paper.svg" className="img-cover" alt=""/></span>
                                                                </Link>
                                                            </td>
                                                ...
                                                this.props.coursesByDraft&&this.props.coursesByDraft.map((draf,n) => {
                                                    return (
                                                        <tr>
                                                            ...
                                                            <td className="align-middle">
                                                                <Link to={`/course-status/${draf.id}`} params={draf.id} ><span className="text-dark-blue"><img style={{height:"20px", width:"20px", cursor:"pointer"}} src="data:image/png;base64,"/></span></Link>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                <Link to={`/course-edit/${draf.id}`} params={draf.id} ><span><img style={{width:"21px", height:"21px", cursor:"pointer"}} src="assets/default/img/icons/paper.svg" className="img-cover" alt=""/></span>
                                                                </Link>
                                                ...
                                                this.props.coursesSearch&&this.props.coursesSearch.map((search,p) => {
                                                    return (
                                                        <tr>
                                                            ...
                                                            <td className="align-middle">
                                                                <Link to={`/course-status/${search.id}`} params={search.id} ><span className="text-dark-blue"><img style={{height:"20px", width:"20px", cursor:"pointer"}} src="data:image/png;base64,"/></span></Link>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                <Link to={`/course-edit/${search.id}`} params={search.id} ><span><img style={{width:"21px", height:"21px", cursor:"pointer"}} src="assets/default/img/icons/paper.svg" className="img-cover" alt=""/></span>
                                                                </Link>
