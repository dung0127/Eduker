                                                    ...
                                                    return (
                                                        <tr>
                                                            ...
                                                            <td className="align-middle">
                                                                ...
                                                                <Link to={`/course-edit/${course.id}`} params={course.id} ><span><img style={{width:"21px", height:"21px", cursor:"pointer"}} src="assets/default/img/icons/paper.svg" className="img-cover" alt=""/></span>
                                                                </Link>
                                                            </td>
